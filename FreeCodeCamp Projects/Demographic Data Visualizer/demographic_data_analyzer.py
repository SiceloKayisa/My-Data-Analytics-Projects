...
def calculate_demographic_data(print_data=True):
    ...
    number_of_bachelors = ( df[ df["education"] == 'Bachelors']).size()
    number_of_people = len(df)

  
    percentage_bachelors = number_of_bachelors/number_of_people*100
    ...
    india_people= df[ (df[ 'native-country'] == 'India') & (df['salary']== ">50K") ] #subseting indian people from the dataframe
    india_occupations = india_people['occupation'].value_counts()
